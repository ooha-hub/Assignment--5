...
\end{align}
They are parallel to y-axis.So they make \vec{90} degrees
...
\begin{align}
 \vec{A}=\vec{q}+\lambda \vec{m}\\ =\myvec{2\\0}+\lambda \myvec{0\\1} \label{2.0.13}
\end{align}
\begin{align}
 \vec{\lambda^2}=\frac{{\vec{-f_1}-\norm{\vec{q}}^2}}{{\norm{\vec{m}}^2}}\\=\frac{{\vec{4}-\vec{4}}}{{\vec{1}}}=0
 \\
\implies \lambda=0 \label{2.0.16}
\end{align}
Sub \eqref{2.0.16} in \eqref{2.0.13}
\begin{align}
...
\label{2.0.19}
\end{align}
comparing equation \eqref{2.0.19} with the circle equation given,
\begin{align}
\vec{x}^T\vec{x} = \vec{4}
\end{align}
\begin{align}
...
\\
\implies r &=2 \label{2.0.23}
\end{align}
Using equation $\eqref{2.0.23}$ and,the area of the sector is obtained as,
\begin{align}
